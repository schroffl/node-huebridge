...
module.exports = bridge => {
	...
	bridge.api.emitter.on('config.full', (respond, body) => respond.success({
		'config': bridge.config.list(),
		'lights': bridge.lights.list(),
		'groups': bridge.groups.list(),
		'scenes': bridge.scenes.list()
	}) );
};